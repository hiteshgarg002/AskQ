...
import com.hrrock.askq.fragments.NotificationsInboxFragment
import com.hrrock.askq.fragments.NotificationsNotificationFragment
import com.hrrock.askq.fragments.UiDesignExploreFragment
import com.hrrock.askq.fragments.UiDesignSavedFragment
...
class NotificationsActivity : AppCompatActivity() {
    ...
    private fun setUpTabs() {
        val viewPager = findViewById<View>(R.id.notificationsViewPager) as ScrollableViewPager
        viewPager.adapter = object : FragmentPagerAdapter(supportFragmentManager) {
            override fun getItem(position: Int): Fragment? {
                var fragment: Fragment? = null

                when (position) {
                    0 -> fragment = NotificationsNotificationFragment()
                    1 -> fragment = NotificationsInboxFragment()
                }
                return fragment
            }
        ...
        val navigationTabStrip = findViewById<View>(R.id.notificationsTabs) as NavigationTabStrip
